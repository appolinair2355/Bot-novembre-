...
EXPIRED_LICENCES = "expired_licences.yaml"
ADMIN_PW = "kouame2025"
...
class TelegramHandlers:
    ...
    def _move_to_expired(self, code: str):
        if not os.path.exists(EXPIRED_LICENCES):
            with open(EXPIRED_LICENCES, "w", encoding="utf-8") as f:
                yaml.dump({"expired": []}, f)
        with open(EXPIRED_LICENCES, "r+", encoding="utf-8") as f:
    ...
    def handle_update(self, update: Dict[str, Any]):
        ...
        self.send_message(chat_id, "Je n'ai pas compris ce message.")
